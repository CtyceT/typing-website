...
footer.innerHTML =
  `
        ...
        <div id="footer-infomation-left">
          <div id="temporary1" class="footer-infomation footer-infomation-left">
            <a href="">佔位符1</a>
          </div>
          <div id="temporary2" class="footer-infomation footer-infomation-left">
            <a href="">佔位符2</a>
          </div>
          <div id="temporary3" class="footer-infomation footer-infomation-left">
            <a href="">佔位符3</a>
          </div>
        </div>
        <!-- *右側頁尾資訊 -->
        <div id="footer-infomation-right">
          <div id="myname" class="footer-infomation footer-infomation-right">
            <a href="">蔡承諺</a>
          </div>
          <div
            id="temporary5"
